...
* /finish - завершение соревнования, подсчёт результатов. При случайном нажатии, можно просто продолжать игру дальше, а при завершении отправить команду /finish ещё раз
